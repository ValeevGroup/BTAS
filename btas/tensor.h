...
namespace btas {
  ...
  */
  ...
  template <class _Tensor, class = typename std::enable_if<btas::is_tensor<_Tensor>::value>::type>
...
namespace serialization {
  ...
  /// boost serialization
  template<class Archive, class _Tensor, class = typename std::enable_if<btas::is_tensor<_Tensor>::value>::type>
