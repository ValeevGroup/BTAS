...
namespace btas{
  ...
  */
  ...
  public:
    ...
    CP_ALS(Tensor &tensor, std::vector<unsigned int> &symms) : CP<Tensor, ConvClass>(tensor.rank()),
  ...
  protected:
    ...
    std::uint64_t size;                   // Total number of elements
    ...
    void update_w_KRP(unsigned int n, std::uint64_t rank, bool &fast_pI,
