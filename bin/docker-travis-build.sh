...
apt-get -yq --no-install-suggests --no-install-recommends --force-yes install g++-7 g++-8 libboost-dev libboost-serialization-dev libblas-dev liblapack-dev liblapacke-dev intel-mkl-2019.4-070 clang-7 clang-8 clang-9 cmake cmake-data
